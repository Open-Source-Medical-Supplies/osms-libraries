// IETF selectors sourced from https://appmakers.dev/bcp-47-language-codes-list/
// used with 'navigator.language'
...
export enum IETF {
  ...
  "el-GR" = "el-GR", //   Modern     - Greek Greece
  ...
  "ko-KR" = "ko-KR", //   Korean     - Republic of Korea
